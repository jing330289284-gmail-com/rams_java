...
public class CustomerDepartmentInfoModel {
	...
	String beforeResponsiblePerson;// 元責任者
	...
	public String getBeforeResponsiblePerson() {
		return beforeResponsiblePerson;
	}

	public void setBeforeResponsiblePerson(String beforeResponsiblePerson) {
		this.beforeResponsiblePerson = beforeResponsiblePerson;
	}
