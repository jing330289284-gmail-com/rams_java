...
public class SiteSearchModel implements Serializable {
	...
	String payOffRange1;// 精算1
	String payOffRange2;// 精算2
	...
	String rowNo;// 番号
	String dataAcquisitionPeriod;// データ期間
	String workDate;// 勤務期間
	String employeeFrom;// 所属
	String systemName;// システム
	String station;// 場所
	...
	public String getDataAcquisitionPeriod() {
		return dataAcquisitionPeriod;
	}

	public void setDataAcquisitionPeriod(String dataAcquisitionPeriod) {
		this.dataAcquisitionPeriod = dataAcquisitionPeriod;
	}
